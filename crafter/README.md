...
=======
```
python main_qrdqn.py --algorithm qrdqn --seed 3 --explore_strat thompson --bootstrapped_qrdqn True --ucb_c 0.5 --qrdqn_always_train_feat False --T-max 1500000 --batch-size 64
```
